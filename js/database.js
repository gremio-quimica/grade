...
window.courses = [
    ...
    { name: "Seminarios", credits: 0, code: "IQWK01", semester: 1, category: 1, workload: 90},
    { name: "Ativ Curricular Extensão", credits: 0, code: "IQWZ50", semester: 1, category: 1, workload: 90},
    { name: "Cálculo I", credits: 6, code: "MAC118", semester: 1, category: 1, workload: 90},
    { name: "Introducao a Computacao", credits: 4, code: "MAW112", semester: 1, category: 1, workload: 90},    
    ...
    { name: "Química Geral II", credits: 2, code: "IQG121", semester: 2, requirements: [0], category: 1, workload: 90},
    { name: "Química Orgânica I", credits: 3, code: "IQO116", semester: 2, requirements: [0], category: 1, workload: 90},
    { name: "Atividades Acc I", credits: 0, code: "IQWX15", semester: 2,category: 1, workload: 90},
    ...
    {name: "Química Ambiental", credits: 2, code: "IQA230", semester: 3, requirements: [9], category: 1, workload: 90},
    ...
    { name: "Química Analítica Clássica II", credits: 2, code: "IQA241", semester: 4, requirements: [15,23], category: 1, workload: 30},
    { name: "Química Analít Clássica Exp II", credits: 1, code: "IQA242", semester: 4, requirements: [15,16,22], category: 1, workload: 60},
    { name: "Química de Coordenação", credits: 2, code: "IQG241", semester: 4, requirements: [18], category: 1, workload: 60},
    { name: "Química de Sólidos", credits: 2, code: "IQG242", semester: 4, requirements: [18], category: 1, workload: 60},
    { name: "Métodos Fís Análise Org", credits: 4, code: "IQO249", semester: 4, requirements: [19], category: 1, workload: 60},
    { name: "Cálculo IV", credits: 4, code: "MAC248", semester: 4, requirements: [12], category: 1, workload: 60},            
    { name: "Química Analít Instrumental I", credits: 2, code: "IQA351", semester: 5, requirements: [22], category: 1, workload: 60},
    { name: "Bioquímica I", credits: 4, code: "IQB358", semester: 5, requirements: [9, 19], category: 1, workload: 30},
    { name: "Introdução a Química Quântica", credits: 3, code: "IQF352", semester: 5, requirements: [21, 27], category: 1, workload: 60},
    { name: "Físico Química Experimental I", credits: 2, code: "IQF357", semester: 5, requirements: [17, 32], category: 1, workload: 60},
    { name: "Fen de Superfície e Eletroquím", credits: 3, code: "IQF362", semester: 5, requirements: [17 ,31], category: 1, workload: 60},  
    { name: "Química Inorgânica Exper I", credits: 2, code: "IQG350", semester: 5, requirements: [25], category: 1, workload: 75},
    { name: "Química Orgânica III", credits: 3, code: "IQO350", semester: 5, requirements: [26], category: 1, workload: 60},
    { name: "Atividades Acad. Optativas (G1)", credits: 4, semester: 5, step: 1, category: 2, workload: 120},        
    { name: "Química Analít Instrumental II", credits: 4, code: "IQA361", semester: 6, requirements: [28, 37], category: 1, workload: 75},
    { name: "Química Analít Instr Exper I", credits: 2, code: "IQA362", semester: 6, requirements: [23, 28, 36], category: 1, workload: 75},
    { name: "Bioquímica II", credits: 2, code: "IQB362", semester: 6, requirements: [29, 17], category: 1, workload: 75},
    { name: "Processos Cinéticos", credits: 3, code: "IQF368", semester: 6, requirements: [32], category: 1, workload: 75},
    { name: "Comp Organ de Metais de Transi", credits: 2, code: "IQG361", semester: 6, requirements: [24], category: 1, workload: 75},
    { name: "Química Orgânica Exp", credits: 2, code: "IQO362", semester: 6, requirements: [1, 34], category: 1, workload: 75},
    { name: "Introducao a Mineralogia", credits: 3, code: "IGL101", semester: 7, category: 1, workload: 75},
    { name: "Química Analít Instr Exper II", credits: 2, code: "IQA472", semester: 7, requirements: [36, 37], category: 1, workload: 75},
    { name: "Espectroscopia Termod Estatíst", credits: 3, code: "IQF470", semester: 7, requirements: [30, 39], category: 1, workload: 75},
    { name: "Química Inorgânica Exper Ii", credits: 2, code: "IQG472", semester: 7, requirements: [33, 40], category: 1, workload: 75},
    { name: "Mét Espectroscóp Quím Inorgân", credits: 2, code: "IQG475", semester: 7, requirements: [24], category: 1, workload: 75},
    { name: "Projeto de Curso", credits: 4, code: "IQWX01", semester: 7, category: 1, workload: 180}, 
    { name: "Físico-química Experimental II", credits: 1, code: "IQF482", semester: 8, requirements: [44], category: 1, workload: 60},
    { name: "Atividades Acad. Livre Escolha", credits: 4, semester: 8, step: 1, category: 3, workload: 120},
    { name: "Atividades Acad. Optativas", credits: 10, semester: 8, step: 1, category: 2, workload: 120}
    ]
]
